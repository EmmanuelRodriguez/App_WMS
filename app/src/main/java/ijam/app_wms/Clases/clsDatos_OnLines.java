...
public class clsDatos_OnLines {
    ...
    public clsDatos_OnLines(int imagen, int imgStatus, String docEntry, int lineNum, String itemCode, String codeBars, String itemName, String quantity,  String tipoCnt) {
        Imagen = imagen;
