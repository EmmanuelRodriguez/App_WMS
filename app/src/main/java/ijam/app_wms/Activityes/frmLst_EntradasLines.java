        ...
        try {
            for (int i = 0; i < oResp.size(); i++) {
                if (Double.parseDouble(oResp.get(i).getsQuantity()) > 0) {
                    d = new clsDatos_OnLines(R.drawable.itm, R.drawable.btncircle_verde, oResp.get(i).getsDocEntry(), oResp.get(i).getiLineNum(), oResp.get(i).getsItemCode(), oResp.get(i).getsCodeBars(), oResp.get(i).getsItemName(), oResp.get(i).getsQuantity(), oResp.get(i).getsQuantityTotal());
                } else {
                    d = new clsDatos_OnLines(R.drawable.itm, R.drawable.btncircle_rojo, oResp.get(i).getsDocEntry(), oResp.get(i).getiLineNum(), oResp.get(i).getsItemCode(), oResp.get(i).getsCodeBars(), oResp.get(i).getsItemName(), oResp.get(i).getsQuantity(), oResp.get(i).getsQuantityTotal());
                }
