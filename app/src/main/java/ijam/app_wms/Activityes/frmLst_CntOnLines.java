...
import ijam.app_wms.Adapters.adpCntInv_Lines;
...
public class frmLst_CntOnLines extends AppCompatActivity {
    ListView oLstLines;
    ProgressDialog oPrgsDialog = null;
    adpCntInv_Lines oAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frmlst_cntonlines);
        ...
        oLstLines =(ListView)findViewById(R.id.list_On_Lines);
    ...
    public void CargaLineas(String sDocEnt){
        ...
        try{
            ...
            if (i>0){
                ...
                alstLineas= oCnt_Lineas.Reupera_CntOn_Lineas(oConn);
            }
            else{
    ...
    public void Llena_OnLineas(final ArrayList<clsCntInv_Lines> oRec) {
        try
        {
            oAdapter = new adpCntInv_Lines(this, getOnLines(oRec)  );
            ...
            oLstLines.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent oAddOnHead = new Intent(frmLst_CntOnLines.this, frmAdd_CntOnLines.class);
